...
from src.constant import COLLECTION_NAME  # Milvus collection name
from src.constant import DEVICE  # Computing device
from src.constant import EMBED_MODEL_ID  # BGE-M3 model identifier
from src.constant import FP16  # Use FP16 precision for reranker
from src.constant import MILVUS_URI  # Milvus database URI
from src.constant import RERANKER_MODEL_ID  # BGE reranker model identifier
