...
from src.constant import DEVICE  # Computing device (cpu/cuda)
from src.constant import EMBED_MODEL_ID  # BGE-M3 model identifier
from src.constant import ENCODE_KWARGS  # Encoding arguments for embeddings
from src.constant import MODEL_KWARGS  # Model arguments for embeddings
from src.constant import PROCESSED_DOCS_FILE  # Path to processed documents file
